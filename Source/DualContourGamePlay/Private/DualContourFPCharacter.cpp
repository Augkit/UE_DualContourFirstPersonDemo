...
ADualContourFPCharacter::ADualContourFPCharacter()
{
	...
	// controller and camera every frame.
	{
		static ConstructorHelpers::FObjectFinder<USkeletalMesh> MeshFinder(
			TEXT("/DualContourFirstPersonDemo/Characters/Mannequins/Meshes/SKM_Manny_Simple.SKM_Manny_Simple"));
		...
		static ConstructorHelpers::FClassFinder<UAnimInstance> InitialFirstPersonAnimFinder(
			TEXT("/DualContourFirstPersonDemo/FirstPerson/Anims/ABP_FP_Copy.ABP_FP_Copy_C"));
		...
		static ConstructorHelpers::FClassFinder<UAnimInstance> InitialFullBodyAnimFinder(
			TEXT("/DualContourFirstPersonDemo/Characters/Mannequins/Anims/Unarmed/ABP_Unarmed.ABP_Unarmed_C"));
		...
		static ConstructorHelpers::FClassFinder<UAnimInstance> PistolFirstPersonAnimFinder(
			TEXT("/DualContourFirstPersonDemo/Variant_Shooter/Anims/ABP_FP_Pistol.ABP_FP_Pistol_C"));
		...
		static ConstructorHelpers::FClassFinder<UAnimInstance> PistolThirdPersonAnimFinder(
			TEXT("/DualContourFirstPersonDemo/Variant_Shooter/Anims/ABP_TP_Pistol.ABP_TP_Pistol_C"));
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> PistolMeshFinder(
			TEXT("/DualContourFirstPersonDemo/Weapons/Pistol/Meshes/SKM_Pistol.SKM_Pistol"));
